<template>
  <main id="Purchase-page">
    <h1>New Purchase</h1>
    <p>Welcome to new Purchase page</p>
          ...
          <div class="top-purchase-section">
            <div class="purchase-top-section-details-left">
              <div class="purchase-custom-id">
                ...
                <label style="color: var(--primary)">{{
                  store.this_purchase_custom_number
                }}</label>
              </div>
            ...
            <div class="purchase-top-section-details-right">
              <div class="form-purchase-date">
                ...
                />
                <div v-if="errors.purchase_date" :class="['errorText']">
                  <div
                    class="errorText-inner"
                    v-for="error in errors.purchase_date"
                    v-bind:key="error.id"
                  >
                    <ul>
                      <li>{{ error }}</li>
              ...
              <div class="form-purchase-reference-holder">
                ...
                <input
                  ...
                  :class="[
                    'form-input-holder',
                    errors.purchase_reference_id ? 'is-invalid' : '',
                  ]"
                  v-model="purchaseInfo.purchase_reference_id"
                />
                <div v-if="errors.purchase_reference_id" :class="['errorText']">
                  <div
                    class="errorText-inner"
                    v-for="error in errors.purchase_reference_id"
                    v-bind:key="error.id"
                  >
                    <ul>
                      <li>{{ error }}</li>
        ...
        <div class="mero-table">
          <section>
            ...
            <div class="button-container-down">
              <button class="create-purchase-btn" @click="createPurchase()">
                Create Purchase
              </button>
            </div>
          </section>
...
export default {
  ...
  setup() {
    ...
    const createPurchase = () => {
      ...
      axios
        .post("/purchase/create", purchase_slip)
        .then((response) => {
