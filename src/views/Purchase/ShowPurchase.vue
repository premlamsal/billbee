<template>
    <main id="Purchase-page">
      ...
      <div class="huge-purchase-container">
        <div class="purchase-head">
          <h1>Purchase # {{ info.custom_purchase_id }}</h1>
        </div>
  
        <div class="Purchase-content">
          <div class="purchase-top-section">
            <div class="head-purchase-section">
            ...
            <div class="top-purchase-section">
              <div class="purchase-top-section-details-left">
                <div class="form-purchase-supplier"></div>
              </div>
              <div class="purchase-top-section-details-middle"></div>
      ...
      const fetchPurchase = () => {
        axios
          ...
          .then((response) => {
            ...
            info.purchase_reference_id = response.data.purchase.purchase_reference_id;
  ...
  .purchase-top-section-details-right {
    display: flex;
    flex-direction: column;
    align-items: end;
  }
  .huge-purchase-container {
    background: #fff;
