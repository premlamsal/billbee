      ...
      <div class="Invoice-content">
        <div class="invoice-top-section">
          <div class="top-invoice-section">
            <div class="invoice-top-section-details-left">
              <div class="return-invoice-custom-id">
                <label>Return Invoice No </label>
                <label style="color: var(--primary)">{{
                  store.this_return_invoice_custom_number
                }}</label>
              </div>
        ...
        <div class="item-table-holder-button-container">
          <div class="" v-if="isItemHolderUpdating">
            <button
              class="btn-update-to-return-invoice"
        ...
        <div class="return-invoice-content-right-side">
        ...
        <div class="mero-table">
          <section>
            ...
            <div class="button-container-down">
              <button class="create-invoice-btn" @click="createReturnInvoice()">
...
export default {
  ...
  setup() {
    ...
    const createReturnInvoice = () => {
      ...
      axios
        .post("/return-invoice/create", invoice_slip)
        .then((response) => {
    ...
    const getUserStoreData = () => {
      let custom_return_invoice_number;

      axios
        .get("user-store/")
        .then((response) => {
          store.return_invoice_id_count =
            response.data.store.return_invoice_id_count;

          console.log(response.data);

          custom_return_invoice_number =
            store.return_invoice_id_count.split("-");

          custom_return_invoice_number[1] =
            parseInt(custom_return_invoice_number[1]) + 1;

          store.this_return_invoice_custom_number =
            custom_return_invoice_number.join("-");

          // console.log(store.this_return_invoice_custom_number);
