<template>
  <main id="Purchase-page">
    ...
    <p>Welcome to Edit Return Purchase page</p>
    ...
    const getReturnPurchase = () => {
      axios
        ...
        .then((response) => {
          ...
          purchaseInfo.note = response.data.return_purchase.note;
          purchaseInfo.return_purchase_date =
            response.data.return_purchase.return_purchase_date;
          purchaseInfo.due_date = response.data.return_purchase.due_date;
          purchaseInfo.sub_total = response.data.return_purchase.sub_total;
          purchaseInfo.discount = response.data.return_purchase.discount;
          purchaseInfo.tax_amount = response.data.return_purchase.sub_total;
          purchaseInfo.grand_total = response.data.return_purchase.grand_total;
