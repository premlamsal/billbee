          ...
          <div class="modal">
            ...
            <div class="modal-body">
              ...
              <div class="form-input-role">
                ...
                <input
                  type="text"
                  placeholder="Role Opening Balance"
                  class="roleOpeningBalanceHolder"
                  v-model="role.opening_balance"
                />
              </div>
              <div class="form-input-role">
                <label> Details</label>
                <textarea
                  type="text"
                  class="roleDetailsHolder"
                  v-model="role.details"
                ></textarea>
              </div>
            </div>
  ...
  export default {
    setup() {
      ...
      const getSingleRole=(role_id)=>{
        ...
        axios.get('role/'+role_id)
        .then(response=>{
          // console.log(response.data.role.name);
          role.id=response.data.role.id
          role.name=response.data.role.name
          role.address=response.data.role.address
          role.phone=response.data.role.phone
          role.opening_balance=response.data.role.opening_balance
          role.details=response.data.role.details;
      ...
      const addRole = () => {
        if (isModalUpdating.value) {
          ...
          formdata.append("address", role.address);
          formdata.append("phone", role.phone);
          formdata.append("opening_balance", role.opening_balance);
          formdata.append("details", role.details);
          axios
